...
#read your file
file=r'Signature-verification-and-automatic-attendance-marking-system\data\attendance_sheets\attendancesheet12.jpg'
...
for boxes in final:
    ...
    if(len(text)==9):
        ...
        cv2.imwrite("Signature-verification-and-automatic-attendance-marking-system\data\signatures\set1\\"+str(text).strip()+".jpeg",cropped_image)
